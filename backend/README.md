...
## Project Structure
    ...
    ├── testapiautodatamod_112361  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112361`
...
2. Clone this repo and `cd testapiautodatamod_112361`
